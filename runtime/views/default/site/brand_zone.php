	...
	<div class="main f_r">
		...
		<ul class="display_list clearfix m_10">
			...
			<li name="goodsItems" class="clearfix win">
				<div class="pic">
					<img src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."/w/200/h/200");?>" width="200px" height="200px" alt="<?php echo isset($item['name'])?$item['name']:"";?>" title="<?php echo isset($item['name'])?$item['name']:"";?>" name="goodsImage" />
				</div>
