		...
		<div class="box_2 m_10">
			...
			<div class="content">
				<ul class="prolist clearfix">
					<li>
						<a href="<?php echo IUrl::creatUrl("/site/products/id/".$this->goods['goods_id']."");?>"><img src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$this->goods['img']."/w/212/h/167");?>" title="<?php echo isset($this->goods['name'])?$this->goods['name']:"";?>" alt="<?php echo isset($this->goods['name'])?$this->goods['name']:"";?>" height="212px" width="167px"></a>
