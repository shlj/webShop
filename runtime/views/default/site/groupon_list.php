	...
	<div class="box">
		<div class="cont">
			...
			<ul class="glist m_10 clearfix">
				...
				<li>
					<h2><a class="f14 bold" href="<?php echo IUrl::creatUrl("/site/products/id/".$item['goods_id']."");?>"><?php echo isset($item['title'])?$item['title']:"";?></a></h2>
					<dl>
						<dt><a class="f_l" href="<?php echo IUrl::creatUrl("/site/products/id/".$item['goods_id']."");?>"><img width="178" height="178" src="<?php echo IUrl::creatUrl("")."".$item['img']."";?>" alt="<?php echo isset($item['title'])?$item['title']:"";?>"></a></dt>
						<dd>
							<p class="m_10">团购价：<b class="orange">￥<?php echo isset($item['regiment_price'])?$item['regiment_price']:"";?></b></p>
							<p class="m_10">原&nbsp;&nbsp;价：<s class="bold">￥<?php echo isset($item['sell_price'])?$item['sell_price']:"";?></s></p>
							<p class="m_10">购买人数：<span class="blue"><?php echo isset($item['sum_count'])?$item['sum_count']:"";?></span></p>
							<p class="m_10"><a href="<?php echo IUrl::creatUrl("/site/products/id/".$item['goods_id']."");?>" class="g_btn_2">原价购买>></a></p>
						</dd>
					</dl>
				</li>
				<?php }?>
